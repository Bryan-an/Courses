...
insert into libros (titulo, autor, editorial, precio, cantidad)
	values ('Alicia en el país de las marivillas', 'Lewis Carroll', 'Atlantida', 10, 200);
insert into libros (titulo, autor, editorial, precio, cantidad)
	values ('Matemática estás ahí', 'Paenza', 'Siglo XXI', 18.8, 200);

-- recuperamos todos los datos de la tabla libros
select * from libros;

-- recuperamos solo el título, autor y editorial de la tabla libros
